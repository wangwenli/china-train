var pageCount=0;
var Pagination = {
    showPageCount: 7, init: function (obj, callback, topFlag) {
        ...
        html.push("<span class=\"curr_page\">第" + (pageIndex+1) + "页</span>,");
        html.push("<span class=\"total total_page\">共" + pageCount + "页</span>");
        html.push("<span class=\"page_jump\">跳转到</span><input id='pageInput' class='pageInput' oldpage='' maxlength='" + pageCount + "' type='text' ><span class=\"page_jump last-page-jump\">页</span>");
        return html.join("");
